                    ...
                    { donations.length > 0 ? (donations.map((donation) => (
                            <View style={styles.historialItem} key={donation.DonationID}>
                                ...
                                <View style={styles.historialTextContainer}>
                                    <Text style={styles.providerText}>¡{donation.DonorFirstName} {donation.DonorLastName} ha donado!</Text>
                                    <Text style={styles.amountText}>{donation.Amount} goofycoins al proyecto: {donation.ProjectName}</Text>
                                    <Text style={styles.amountText}>Propietario: {donation.OwnerFirstName} {donation.OwnerLastName}</Text>
                                </View>
                            </View>
                    ))): (
